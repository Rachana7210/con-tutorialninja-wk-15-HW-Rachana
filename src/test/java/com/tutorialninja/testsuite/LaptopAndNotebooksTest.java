...
public class LaptopAndNotebooksTest extends BaseTest {
    ...
    public void verifyThatUserPlaceOrderSuccessfully () throws InterruptedException {
        ...
        laptopsAndNotebooks.enterName("Sheena");
        laptopsAndNotebooks.enterLastName("Soni");
        laptopsAndNotebooks.enterEmail("Sheena@gmail.com");
        laptopsAndNotebooks.enterTelephone("089765345");
        laptopsAndNotebooks.enterAddress("Kenmore Road");
        laptopsAndNotebooks.enterCity("London");
        laptopsAndNotebooks.enterPostcode("HA3 3JU");
